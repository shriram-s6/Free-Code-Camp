...
def draw_cat_plot():
    ...
    fig = sns.catplot(x='variable', kind='count', hue='value', data=df_cat, col='cardio').set_axis_labels('variable', 'total')
    fig = fig.fig
...
def draw_heat_map():
    ...
    sns.heatmap(corr, mask=mask, fmt='0.1f', vmax=0.3, linewidths=0.5, square=True, cbar_kws = {'shrink':0.5},annot=True, center=0)
